...
export default function TestPersistence() {
  ...
  const { combinations, addCombination, clearAllCombinations } =
    useCombinations();
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="px-4 py-2 bg-accent/100 text-white rounded-lg hover:bg-blue-600 transition-colors"
          >
        ...
        {testResult && (
          <div
            className={`p-3 rounded-lg ${testResult.includes("✅") ? "bg-green-50 text-green-800" : testResult.includes("❌") ? "bg-red-50 text-red-800" : "bg-yellow-50 text-yellow-800"}`}
          >
            {testResult}
          </div>
        )}

        <div className="text-xs text-muted bg-muted p-3 rounded-lg">
